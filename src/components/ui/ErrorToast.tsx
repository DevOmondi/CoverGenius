    ...
    <AnimatePresence>
      ...
      >
        <div className="relative bg-white  border border-red-200 rounded-lg shadow-lg overflow-hidden">
          {/* Progress bar */}
          <div className="absolute top-0 left-0 h-1 bg-red-500/50 dark:bg-red-400/50 w-full">
            <motion.div
          ...
          <div className="p-4 flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              {errorCode && (
                <div className="mt-2 text-xs text-red-500 dark:text-red-400 bg-red-100 dark:bg-red-900/30 px-2 py-1 rounded inline-block">
